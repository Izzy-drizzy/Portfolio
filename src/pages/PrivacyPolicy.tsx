    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)]">
      <div className="max-w-3xl mx-auto px-7 md:px-10 py-24">
        ...
        >
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-sm text-[var(--text-400)] hover:text-[var(--text)] transition-colors mb-12"
          >
            <ArrowLeft size={16} />
            Back to home
          </Link>

          <p className="text-sm text-[var(--text-400)] mb-4">Last updated: March 2026</p>
          <h1 className="text-4xl md:text-5xl font-medium tracking-tight mb-4">
            Privacy Policy<span className="text-[#F45D01]">.</span>
          </h1>
          <p className="text-[var(--text-400)] mb-16 text-sm leading-relaxed">
