        ...
        <section className="px-5 md:px-10 py-20 border-t border-gray-800">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }}
            ...
            <motion.div variants={fadeUp}>
              ...
              <h2 className="text-2xl font-semibold mb-4">Five Screen Transformations</h2>
        ...
        <section className="px-5 md:px-10 py-20 border-t border-gray-800">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }}
            ...
            <motion.div variants={fadeUp}>
              ...
              <h2 className="text-2xl font-semibold mb-8">Demo Outcomes</h2>
            </motion.div>
        ...
        <section className="px-5 md:px-10 py-20 border-t border-gray-800">
          <motion.div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6"
            ...
            <div>
              ...
              <h2 className="text-2xl font-semibold">Hobpay</h2>
