...
function ImageCarousel() {
  ...
  return (
    <div className="relative w-full h-full rounded-xl overflow-hidden group">
      {images.map((src, i) => (
        <img key={i} src={src} alt={`Lead Trader mockup ${i + 1}`}
        ...
        <section className="px-5 md:px-10 py-20 border-t border-gray-800">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }}
            ...
            <motion.div variants={fadeUp}>
              ...
              <h2 className="text-2xl font-bold mb-4">Five Screen Transformations</h2>
            ...
            <div className="space-y-6">
              {[
                ...
                <motion.div key={screen.num} variants={fadeUp}
                  className="rounded-xl border border-gray-800 bg-[#1A1A1A] p-6 md:p-8 space-y-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    <div className="lg:col-span-3">
                      ...
                      <span className="text-xs px-2.5 py-1 rounded-full border border-gray-700 text-gray-500">{screen.tag}</span>
                    </div>
                    <div className="lg:col-span-8 lg:col-start-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        <p className="text-xs text-gray-600 uppercase tracking-widest mb-2">Before</p>
                        <p className="text-sm text-gray-500 leading-relaxed">{screen.before}</p>
                      </div>
                      <div>
                        <p className="text-xs text-[#F45D01] uppercase tracking-widest mb-2">After</p>
                        <p className="text-sm text-gray-300 leading-relaxed">{screen.after}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  {screen.beforeImg ? (
                    <div className="grid grid-cols-2 gap-3 pt-2 border-t border-gray-800/60">
                      <div>
                        <p className="text-xs text-gray-600 uppercase tracking-widest mb-2">Before</p>
                        <div className="rounded-lg overflow-hidden border border-gray-800 bg-[#111] max-h-[420px]">
                    ...
                    <div className="pt-2 border-t border-gray-800/60">
                      <p className="text-xs text-[#F45D01] uppercase tracking-widest mb-2">After</p>
                      <div className="rounded-lg overflow-hidden border border-gray-800 bg-[#111] max-w-xs max-h-[420px]">
                        <ImageZoom src={screen.afterImg!} alt={`${screen.title} after`} className="w-full h-full object-contain max-h-[420px]" />
                      </div>
                    </div>
                  )}
        ...
        <section className="px-5 md:px-10 py-20 border-t border-gray-800">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }}
            ...
            <motion.div variants={fadeUp}>
              ...
              <h2 className="text-2xl font-bold mb-8">Demo Outcomes</h2>
            </motion.div>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex gap-3 text-sm leading-relaxed">
                      ...
                      <span><span className="text-gray-200">{item.label}: </span><span className="text-gray-400">{item.detail}</span></span>
                    </li>
                  ))}
                </ul>
              </motion.div>
            ...
            <motion.div variants={fadeUp} className="rounded-xl border border-gray-800 bg-[#1A1A1A] p-8 grid grid-cols-1 lg:grid-cols-12 gap-6">
              <div className="lg:col-span-4">
                ...
                <h3 className="text-xl font-bold">The Demo as a Decision-Making Tool</h3>
              </div>
        ...
        <section className="px-5 md:px-10 py-20 border-t border-gray-800">
          <motion.div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6"
            ...
            <div>
              ...
              <h2 className="text-2xl font-bold">Hobpay</h2>
              <p className="text-sm text-gray-400 mt-1">Cross-platform fintech redesign recovering 28% of blocked users</p>
            </div>
            <Link to="/work/Hobpay"
